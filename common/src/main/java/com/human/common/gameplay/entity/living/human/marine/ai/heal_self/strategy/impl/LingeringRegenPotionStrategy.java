...
/**
 * Strategy for using lingering potions of regeneration.
 */
public class LingeringRegenPotionStrategy implements HealingStrategy {

    @Override
    public boolean isValidItemStack(ItemStack itemStack) {
        return itemStack.is(Items.LINGERING_POTION) && HealingStrategyUtil.hasMobEffect(itemStack, MobEffects.REGENERATION);
    }
    ...
    public double score(LivingEntity livingEntity, ReadableWorldState worldState, ItemStack itemStack) {
        ...
        var healing = HealingStrategyUtil.estimateRegenHealing(itemStack) * 0.25f;
