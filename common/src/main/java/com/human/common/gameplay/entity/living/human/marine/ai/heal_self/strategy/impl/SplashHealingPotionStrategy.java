...
/**
 * Strategy for using splash potions of instant healing.
 */
public class SplashHealingPotionStrategy implements HealingStrategy {

    @Override
    public boolean isValidItemStack(ItemStack itemStack) {
        return itemStack.is(Items.SPLASH_POTION) && HealingStrategyUtil.hasMobEffect(itemStack, MobEffects.HEAL);
    }
    ...
    public double score(LivingEntity livingEntity, ReadableWorldState worldState, ItemStack itemStack) {
        ...
        var healing = HealingStrategyUtil.getInstantHealthHealing(itemStack) * 0.75f;
