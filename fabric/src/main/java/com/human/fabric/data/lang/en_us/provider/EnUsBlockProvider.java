...
public class EnUsBlockProvider {
    ...
    public static final Consumer<FabricLanguageProvider.TranslationBuilder> CONSUMER = builder -> {
        ...
        addBlock(builder, HumanBlocks.AMMO_CHEST, "Ammo Chest");
        addBlock(builder, HumanBlocks.SENTRY_TURRET, "Sentry Turret");
        addBlock(builder, CoreBlocks.ASH_BLOCK, "Ash Block");
        addBlock(builder, HumanBlocks.NUKE_BLOCK, "Nuke Block");
        ...
        HumanBlocks.DYE_COLOR_TO_CONCRETE_SLAB.forEach(
            (key, value) -> addBlock(builder, value, format(key.getName()) + " Concrete Slab")
        );
        HumanBlocks.DYE_COLOR_TO_CONCRETE_STAIRS.forEach(
        ...
        addBlock(builder, HumanBlocks.RAZOR_WIRE, "Razor Wire");
        ...
        addBlock(builder, HumanBlocks.INDUSTRIAL_FURNACE, "Industrial Furnace");
        addBlock(builder, HumanBlocks.BATTERY, "Battery");
        addBlock(builder, HumanBlocks.INFINITE_POWER_GENERATOR, "Infinite Power Generator");
        addBlock(builder, HumanBlocks.SOLAR_PANEL, "Solar Panel");
        addBlock(builder, HumanBlocks.THERMAL_GENERATOR, "Thermal Generator");
        addBlock(builder, HumanBlocks.WIND_TURBINE, "Wind Turbine");
