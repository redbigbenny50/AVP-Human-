...
public class HumanBlockTagProvider extends FabricTagProvider.BlockTagProvider {

    public HumanBlockTagProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> completableFuture) {
    ...
    private void addNeedsIronToolBlocks() {
        getOrCreateTagBuilder(BlockTags.NEEDS_IRON_TOOL)
            ...
            .add(
                ...
                HumanBlocks.CRYOTUBE.get(),
                HumanBlocks.CRYO_TOP_CORE.get(),
                HumanBlocks.CRYO_BOTTOM_CORE.get(),
                HumanBlocks.CRYO_TOP_CENTER.get(),
                HumanBlocks.CRYO_MIDDLE_CENTER.get(),
                HumanBlocks.CRYO_BOTTOM_CENTER.get(),
                HumanBlocks.CRYO_TOP_CORNER.get(),
                HumanBlocks.CRYO_MIDDLE_CORNER.get(),
                HumanBlocks.CRYO_BOTTOM_CORNER.get(),
    ...
    private void addCommonBlockTags() {
        ...
        getOrCreateTagBuilder(CommonBlockTags.ORES)
            .setReplace(false)
            .addTag(HumanCommonBlockTags.ORES_ALUMINUM)
            .addTag(HumanCommonBlockTags.ORES_AUTUNITE)
            .addTag(HumanCommonBlockTags.ORES_LEAD)
            .addTag(HumanCommonBlockTags.ORES_LITHIUM)
            .addTag(HumanCommonBlockTags.ORES_MONAZITE)
            .addTag(HumanCommonBlockTags.ORES_TITANIUM)
            .addTag(HumanCommonBlockTags.ORES_ZINC);

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_ALUMINUM)
            .setReplace(false)
            .addTag(HumanCommonBlockTags.ORES_BAUXITE);

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_AUTUNITE)
            .setReplace(false)
            .add(CoreBlocks.AUTUNITE_ORE.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_BAUXITE)
            .setReplace(false)
            .add(CoreBlocks.BAUXITE_ORE.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_GALENA)
            .setReplace(false)
            .add(CoreBlocks.GALENA_ORE.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_LEAD)
            .setReplace(false)
            .addTag(HumanCommonBlockTags.ORES_GALENA);

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_LITHIUM)
            .setReplace(false)
            .add(CoreBlocks.LITHIUM_ORE.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_MONAZITE)
            .setReplace(false)
            .add(CoreBlocks.MONAZITE_ORE.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_TITANIUM)
            .setReplace(false)
            .add(CoreBlocks.DEEPSLATE_TITANIUM_ORE.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.ORES_ZINC)
            .setReplace(false)
        ...
        getOrCreateTagBuilder(CommonBlockTags.STORAGE_BLOCKS)
            .setReplace(false)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_ALUMINUM)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_BRASS)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_FERROALUMINUM)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_LEAD)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_ALUMINUM)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_LEAD)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_TITANIUM)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_ZINC)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_STEEL)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_TITANIUM)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_URANIUM)
            .addTag(HumanCommonBlockTags.STORAGE_BLOCKS_ZINC);

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_ALUMINUM)
            .setReplace(false)
            .add(CoreBlocks.ALUMINUM_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_BRASS)
            .setReplace(false)
            .add(CoreBlocks.BRASS_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_FERROALUMINUM)
            .setReplace(false)
            .add(HumanFerroaluminumBlocks.FERROALUMINUM_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_LEAD)
            .setReplace(false)
            .add(CoreBlocks.LEAD_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_ALUMINUM)
            .setReplace(false)
            .add(CoreBlocks.RAW_BAUXITE_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_LEAD)
            .setReplace(false)
            .add(CoreBlocks.RAW_GALENA_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_TITANIUM)
            .setReplace(false)
            .add(CoreBlocks.RAW_TITANIUM_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_RAW_ZINC)
            .setReplace(false)
            .add(CoreBlocks.RAW_ZINC_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_STEEL)
            .setReplace(false)
            .add(HumanSteelBlocks.STEEL_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_TITANIUM)
            .setReplace(false)
            .add(HumanTitaniumBlocks.TITANIUM_BLOCK.get());

        getOrCreateTagBuilder(HumanCommonBlockTags.STORAGE_BLOCKS_URANIUM)
            .setReplace(false)
